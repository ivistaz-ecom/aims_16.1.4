...
function NextSeo({ title, description, path, metaImage }) {
  ...
  const domainName = typeof window !== "undefined" ? window.location.origin : "https://staging.theaims.ac.in"
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            url: "https://staging.theaims.ac.in/",
            potentialAction: {
              "@type": "SearchAction",
              target: `https://staging.theaims.ac.in${path}`,
