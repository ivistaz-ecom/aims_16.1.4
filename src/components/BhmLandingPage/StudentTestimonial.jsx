...
const StudentTestimonial = () => {
  ...
  return (
    <section className="mb-6 md:mb-10 py-8 md:py-12 px-4" style={{ backgroundColor: "#531675" }}>
      <div className="container mx-auto max-w-6xl">
        {/* Section Title */}
        <h2 className="text-white text-3xl md:text-4xl lg:text-5xl playfair-600 mb-4 md:mb-10">
          Student Testimonial
        </h2>
