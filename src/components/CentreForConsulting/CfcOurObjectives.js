                  ...
                  <div>
                    <ul className="list-disc list-inside text-start monser-400 text-lg lg:text-[18px] flex flex-col gap-4">
                      <li className="flex items-start gap-3">
                        ...
                        Enhance the practical capabilities of AIMS students and
                        faculty through hands-on learning and industry exposure
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-black">•</span>
                        Work against advance fee collection from
                        Corporates/Businesses and provide pro-bono services to
                        NGOs
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-black">•</span>
                        Facilitate student participation in real-world projects
                        to build industry-relevant skills
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-black">•</span>
                        Bridge the gap between academic teaching and practical
                        work in India
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-black">•</span>
                        Support faculty in improving teaching quality through
                        practical work and exposure to best practices
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-black">•</span>
                        Utilise AIMS and ACC resources for value-added
                        initiatives that benefit students, faculty, and the
                        community
                      </li>
                    </ul>
                  </div>
