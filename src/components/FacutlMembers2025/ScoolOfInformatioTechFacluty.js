...
const ScoolOfInformatioTechFacluty = () => {
    ...
    const fetchFacultyData = async () => {
        try {
            ...
            // Fetch faculty members with category 20 (School of Information Technology)
            const response = await fetch(
                `${API_CONFIG.SERVER_URL}faculty-member?categories=20&per_page=100&_embed&acf&production=${API_CONFIG.PRODUCTION_SERVER_ID}`
            )
...
export default ScoolOfInformatioTechFacluty
