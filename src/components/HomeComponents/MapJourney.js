  ...
  const mapJourney = [
    {
      ...
      embedUrl: "https://www.instagram.com/reel/DQBERDdkmJS/?utm_source=ig_embed&amp;utm_campaign=loading"
    },
    {
      title: "Transforming Education with Top Programs",
      description:
        "Transforming Education with Top Programs like MBA, BBA, BHM, MCA, BCA, MCom, BCom & more!",
      date: "Jan 08, 2025",
      duration: "Duration: 02:24",
      link: "https://www.instagram.com/aimsinstitutes1994/",
      embedUrl: "https://www.instagram.com/reel/DP85K4ek0Vv/?utm_source=ig_embed&amp;utm_campaign=loading"
    },
    {
      title: "AIMS School of Business MBA Championship",
      description:
        "AIMS School of Business MBA Wins Overall Championship Trophy | AIMS Institutes",
      date: "Mar 19, 2025",
      duration: "00:00",
      link: "https://www.instagram.com/aimsinstitutes1994/",
      embedUrl: "https://www.instagram.com/reel/DP3cESUExk-/?utm_source=ig_embed&amp;utm_campaign=loading"
    },
  ];
  return (
    <>
      <div className="bg-[#C6F3EA] py-10 lg:px-8 px-4">
        ...
        <div className="container mx-auto pt-10">
          <div className="flex lg:flex-row flex-col gap-4">
            {mapJourney.map((item, index) => (
              <div
                key={index}
                className="lg:max-w-sm rounded-2xl overflow-hidden"
              >
                {/* Instagram Embed for all items */}
                      ...
                      <div style={{ padding: '16px' }}>
                        ...
                        <p style={{
                          ...
                          <a 
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                          >A post shared by AIMS Institutes (@aimsinstitutes1994)</a>
                        </p>
                      </div>
                    </blockquote>
                  </div>
        ...
        <div className="container mx-auto pt-10 flex gap-5 items-center lg:px-0 px-4">
          ...
          <div className="flex gap-4">
            ...
            <Link href="https://www.facebook.com/AIMS1994" target="_blank"><CiFacebook size={30} /></Link>
            <Link href="https://x.com/AIMSinstitutes" target="_blank"><RiTwitterXFill size={30} /></Link>
            <Link href="https://www.youtube.com/@AIMSInstitutesBangalore" target="_blank"><SlSocialYoutube size={30} /></Link>
