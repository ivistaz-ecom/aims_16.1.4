              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="flex flex-col order-2 lg:order-1 justify-center">
                  ...
                  <ul className="list-disc text-start monser-400 flex flex-col gap-4 md:pl-6 pl-4">
                    ...
                    <li className="text-lg lg:text-[18px] monser-400">
                      Facilitate strategic collaborations with Global
                      Universities/Institutions and Organisations of repute for
                      activities like student/faculty exchange programs, joint
                      research and conferences, and facilitating intake into
                      various courses offered at AIMS Institutes, apart from
                      providing career pathways for AIMERS
                    </li>
                    <li className="text-lg lg:text-[18px] monser-400">
                      Provide a support system and assistance to international
                      students and professors visiting AIMS Institutes
                    </li>
                    <li className="text-lg lg:text-[18px] monser-400">
                      Plan and organise global immersion programs that add value
                      for AIMERS and host delegations from foreign Universities
                      and organisations
                    </li>
                  </ul>
                </div>
