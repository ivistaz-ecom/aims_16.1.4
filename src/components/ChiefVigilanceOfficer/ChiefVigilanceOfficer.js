...
const ExaminerData = [
  {
    title: "Chief Vigiliance Officer",
    titles: ["About  Founder", " Founder’s Message"],
    name: "Mr. Shridhar R G",
    study: "MBA",
    designation: "Director, Administration and Infrastructure",
    image: "/chief-vigilance-officer/shridhar.png",
    email: "director.admin_infra@theaims.ac.in",
  },
];
      ...
      <div className="px-4 lg:px-8">
        <div className="container mx-auto flex flex-col py-10 space-y-4">
          <div className="space-y-2">
            <p className="text-lg">
              The CVO ensures ethical practices, regulatory compliance, and
              transparency across institutional processes.
            </p>
          </div>
        </div>
      </div>
          ...
          >
            ...
            <div className="lg:w-2/3 space-y-5 text-center lg:text-left">
              ...
              <div>
                ...
                <div className="-mt-1 text-[20px] md:text-[20px] lg:text-[20px] text-[#A22877] !font-regular whitespace-pre-line">
                  <a href={`mailto:${item.email}`} className="underline cursor-pointer">{item.email}</a>
                </div>
              </div>
